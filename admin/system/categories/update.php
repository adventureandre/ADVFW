...
<div class="content form_create">
    ...
    <article>
        ...
        if (!empty($data['SendPostForm'])):
            ...
            $read = new Read;
            $read->ExeRead("adv_categories", "WHERE category_id = :id", "id={$catid}");
            if (!$read->getResult()):
        ...
        if($checkCreate && empty($cadastra)):
            ...
            ADVErro("A {$tipo} <b>{$data['category_title']}</b> foi cadastrada com sucesso no sistema! Continue atualizando a mesma!", ADV_ACCEPT);
        endif;
